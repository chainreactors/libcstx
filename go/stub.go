...
func (g *Graph) IngestJSONL(string, []byte, string, string) (*IngestResult, error) {
	return nil, errStub
}
...
func (g *Graph) SubgraphNodeIDs([]string, uint32) ([]string, []string, error) {
...
func NewCASStore() *CASStore                                   { return nil }
func (s *CASStore) Close()                                     {}
func CanonicalHash([]byte) string                              { return "" }
func (s *CASStore) LoadRoot(string, []byte) error              { return errStub }
func (s *CASStore) LoadMap(string, []byte) error               { return errStub }
func (s *CASStore) Export(string) ([]byte, error)              { return nil, errStub }
func (s *CASStore) TreeBuild([]byte) (string, error)           { return "", errStub }
func (s *CASStore) TreeUpdate(string, []byte) (string, error)  { return "", errStub }
func (s *CASStore) TreeDiff(string, string) (*TreeDiff, error) { return nil, errStub }
func (s *CASStore) TreeFind(string, string) (string, bool)     { return "", false }
func (s *CASStore) TreeEntries(string) ([]byte, error)         { return nil, errStub }
